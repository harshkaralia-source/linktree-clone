                ...
                <nav className="hidden lg:flex gap-8">
                    {navLinks.map(item => (
                        <Link
                            href='/'
                            key={item}
                            className='text-[15.4px] text-gray-600 cursor-pointer'
                        >
                            {item}
                        </Link>
                    ))}
